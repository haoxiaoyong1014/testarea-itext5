...
public class DynamicFooter
{
     ...
     * </a>
     * <p>
     * I cannot reproduce the observations by the OP.
     * </p>
     * @see #createPdf(ArrayList, FooterTable, String)
     */
    @Test
    public void testDynamicFooterLikeAyZagen() throws IOException, DocumentException
    {
        ...
        createPdf(htmlStrings, new FooterTable(), new File(RESULT_FOLDER, "DynamicFooterLikeAyZagen.pdf").getPath());
    }
     ...
     * </a>
     * <p>
     * page event listener of the OP
     * </p>
     * @see #testDynamicFooterLikeAyZagen()
     */
    static class FooterTable extends PdfPageEventHelper
    {
        static String titleIndex;
